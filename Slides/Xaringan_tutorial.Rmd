...
style_duo_accent(primary_color = "#23395b", secondary_color = "#EAECEE")
```
...
4. Hasta el momento no sé como hacer correr código interno de *R* y que los gráficos de salida se muestren en la presentación final (web)
]
...
Este parámetro forma parte del css *hygge* y soporta los siguientes colores:
...
*La distribución de los elementos es personalizadar*
